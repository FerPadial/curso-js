...
const btn_filtragem=document.querySelector("#btn_filtragem");
...
btn_filtragem.addEventListener("click",(evt)=>{
    if(f_filtronome.value==""){
        preencherdgv(`http://127.0.0.1:1880/pesquisartodoscontatos`);
    }else{
        preencherdgv(`http://127.0.0.1:1880/filtrarcontatos/${f_filtronome.value}`);
    }
})