...
class Bola{
    constructor(arrayBolas,palco){
        ...
        this.id=Date.now()+"_"+Math.floor(Math.random()*100000000000)   //isso é pra evitar que o ID da bola se repita
        this.desenhar()
        this.controle=setInterval(this.controlar, 10);
        this.eu=document.getElementById(this.id)  //vai associar a bolinha com o ID gerado
        numBola++
        num_objetos.innerHTML=numBola
    }
    minhaPos=()=>{  //posicao da bola no array
